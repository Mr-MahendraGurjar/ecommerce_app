...
import 'package:ecommerce_app/models/login_data.dart';
...
import 'package:ecommerce_app/screens/Favourites/index.dart';
import 'package:ecommerce_app/screens/HomePage/index.dart';
  ...
  void onChangePage() {
    switch (typeHome.value) {
      ...
      case TYPE_HOME.CART:
        ...
        break;
      case TYPE_HOME.NOTI:
        currentPage.value = const Favourites();
        break;
      case TYPE_HOME.USER:
